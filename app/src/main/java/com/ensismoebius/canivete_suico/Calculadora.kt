...
class Calculadora : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mais.setOnClickListener {
            txtformula.text = txtformula.text.toString() + "+"
        }
